...
**报告ID**: RPT-LANGGRAPH-FULL-20260425232045
**生成时间**: 2026-04-25T23:20:45.143448
...
**失败原因**: 信息不全触发状态不匹配: 预期False, 实际0.86; 完整度评分不达标: 预期>=0.8, 实际0.00
...
**失败原因**: 信息不全触发状态不匹配: 预期False, 实际0.96; 完整度评分不达标: 预期>=0.8, 实际0.00
...
**失败原因**: 信息不全触发状态不匹配: 预期True, 实际0.46
...
**失败原因**: 信息不全触发状态不匹配: 预期True, 实际0.62; 分诊路径不匹配: 预期包含'uncertain', 实际'common_fast_path'; 置信度级别不匹配: 预期['insufficient_data', 'low'], 实际'medium'
...
**失败原因**: 信息不全触发状态不匹配: 预期True, 实际0.61
...
**失败原因**: 信息不全触发状态不匹配: 预期True, 实际0.59
...
**失败原因**: 信息不全触发状态不匹配: 预期False, 实际0.86; 完整度评分不达标: 预期>=0.7, 实际0.00; 诊断关键词不匹配: 预期包含['脂肪肝', 'NAFLD'], 实际'代谢相关脂肪性肝病 (MASLD)'
...
**失败原因**: 信息不全触发状态不匹配: 预期False, 实际0.73; 完整度评分不达标: 预期>=0.7, 实际0.00
...
**失败原因**: 信息不全触发状态不匹配: 预期False, 实际0.86; 完整度评分不达标: 预期>=0.8, 实际0.00; 诊断关键词不匹配: 预期包含['乙肝', '病毒性肝炎', 'HBV'], 实际'慢性乙型肝炎'
...
**失败原因**: 信息不全触发状态不匹配: 预期False, 实际0.91; 完整度评分不达标: 预期>=0.8, 实际0.00; 分诊路径不匹配: 预期包含'common', 实际'rare_deep_path'; 罕见病预警状态不匹配: 预期False, 实际True
...
**失败原因**: 信息不全触发状态不匹配: 预期True, 实际0.69; 分诊路径不匹配: 预期包含'uncertain', 实际'common_fast_path'; 置信度级别不匹配: 预期['insufficient_data', 'low'], 实际'high'
...
**失败原因**: 信息不全触发状态不匹配: 预期False, 实际0.84; 完整度评分不达标: 预期>=0.8, 实际0.00
...
**失败原因**: 信息不全触发状态不匹配: 预期False, 实际0.77; 完整度评分不达标: 预期>=0.7, 实际0.00; 诊断关键词不匹配: 预期包含['脂肪肝'], 实际'代谢相关脂肪性肝病 (MASLD)'
...
**失败原因**: 信息不全触发状态不匹配: 预期False, 实际0.86; 完整度评分不达标: 预期>=0.8, 实际0.00; 分诊路径不匹配: 预期包含'common', 实际'uncertain'; 置信度级别不匹配: 预期['medium', 'low'], 实际'insufficient_data'
...
**失败原因**: 信息不全触发状态不匹配: 预期False, 实际0.82; 完整度评分不达标: 预期>=0.8, 实际0.00
