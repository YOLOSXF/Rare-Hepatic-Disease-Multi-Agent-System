...
**报告ID**: RPT-PATIENT-CASES-20260425222725
**生成时间**: 2026-04-25T22:27:25.664623
...
- 实际触发信息不全: True
- 预期缺失字段: ['ALT', 'AST', 'TBil']
- 实际缺失字段: ['AST（肝功能）', 'ALT（肝功能）', 'TBil（肝功能）']
- 数据完整度评分: 0.42
...
- 实际缺失字段: ['性别', 'TBil（肝功能）', '饮酒史', '腹部影像学（超声/CT/MRI）', '用药史', 'AST（肝功能）', '年龄']
- 数据完整度评分: 0.18
