...
**报告ID**: RPT-LANGGRAPH-FULL-20260425232711
**生成时间**: 2026-04-25T23:27:11.439893
...
**失败原因**: 分诊路径不匹配: 预期包含'uncertain', 实际'common_fast_path'; 置信度级别不匹配: 预期['insufficient_data', 'low'], 实际'medium'
...
**失败原因**: 分诊路径不匹配: 预期包含'uncertain', 实际'common_fast_path'; 置信度级别不匹配: 预期['insufficient_data', 'low'], 实际'high'
